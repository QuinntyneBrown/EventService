...
using static EventService.Features.Accounts.AddOrUpdateProfileCommand;
using static EventService.Features.Accounts.GetProfilesQuery;
using static EventService.Features.Accounts.GetProfileByIdQuery;
using static EventService.Features.Accounts.RemoveProfileCommand;
